...
return ['milona_yesiltik2', 'milona_carpi'].includes(reaction.emoji.name) && user.id === kullanıcı.id;
};
...
await mesaj.react("827479367852359730")
await mesaj.react("825673698299215882")
...
if (reaction.emoji.name === 'milona_yesiltik2') {
